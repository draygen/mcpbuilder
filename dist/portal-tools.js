...
export const portalTools = [
    {
        name: "portal_health",
        description: "Check the health of the SyncForge (MFT) portal — the Spring Boot service fronted by Nginx on port 8888. " +
            "Returns status, version, and any reported subsystem health.",
        inputSchema: { type: "object", properties: {} },
    },
    {
        name: "portal_nginx_check",
        description: "Check if Nginx is responding on port 8888 (the public gateway for all Drayhub services). " +
...
async function portalFetch(path, timeoutMs = 8000) {
...
// Handler
// ---------------------------------------------------------------------------
export async function handlePortalTool(name, _args) {
    switch (name) {
        // -----------------------------------------------------------------------
        case "portal_health": {
...
//# sourceMappingURL=portal-tools.js.map